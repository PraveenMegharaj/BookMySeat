...
const ReservedGroundFloor = ({groundFloorData, onSeatClick, groundFloorReservedData}) => {
  ...
  useEffect(() => {
    // console.log(groundFloorReservedData)
    if (groundFloorData && groundFloorReservedData) {
      ...
      seats.forEach(row => {
        const newRow = row.map(seat => {
          ...
          const reservedSeat = groundFloorReservedData.find(reservedSeat =>  reservedSeat.seat.seatNumber === seat.id);
          if (reservedSeat) {
  ...
  }, [groundFloorData,seats, groundFloorReservedData]);
...
export default ReservedGroundFloor